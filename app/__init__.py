...
def register_commands(app):
    ...
    def forge(user, photo, tag, comment, collection, follow):
        ...
        fake_admin()
        click.echo("Generating fake %s users" % user)
        fake_user(user)
        click.echo("Generating fake %s follows" % follow)
        fake_follow(follow)
        click.echo("Generating fake %s tags" % tag)
        fake_tag(tag)
        click.echo("Generating fake %s photos" % photo)
        fake_photo(photo)
        click.echo("Generating fake %s comments" % comment)
        fake_comment(comment)
        click.echo("Generating fake %s collections" % collection)
